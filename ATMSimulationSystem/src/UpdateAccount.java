...
public class UpdateAccount {
 ...
 public void updateName(Long accountNo, Connection connection) {
  try {
   ...
   System.out.println("Something went wrong while updating name ! Please Try Again...." + e.getMessage());
  }
 }
 ...
 public void updatePhone_no(Long accountNo, Connection connection) {
  try {
   ...
   System.out.println("Something went wrong while updating phone ! Please Try Again...." + e.getMessage());
  }
 }
 // -----------------------------------------------------------------------------------------------------------------
 ...
 public void updatePin(Long accountNo, Connection connection) {
  try {
   ...
   while (true) {
    System.out.println(color.yellow
      + "\t( Note : For your security, never share your PIN or confidential information with anyone.)" + color.reset);
